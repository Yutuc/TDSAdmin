...
import kotlinx.android.synthetic.main.activity_choose_user_for_edit_user_goals.*

class ChooseUserForEditUserGoalsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_choose_user_for_edit_user_goals)
        ...
        recyclerview_choose_user_for_edit_user_goals.addItemDecoration(DividerItemDecoration(this, DividerItemDecoration.VERTICAL))
        recyclerview_choose_user_for_edit_user_goals.adapter = adapter
