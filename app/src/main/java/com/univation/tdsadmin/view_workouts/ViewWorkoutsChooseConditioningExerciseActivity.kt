...
class ViewWorkoutsChooseConditioningExerciseActivity : AppCompatActivity() {

    companion object{
        val exerciseMap = HashMap<String, ExerciseDatabaseObject>()
        val exerciseMapCopy = HashMap<String, ExerciseDatabaseObject>()
        var conditioningExerciseClicked : ExerciseDatabaseObject? = null
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_choose_conditioning_exercise)

        setTitle("Select an exercise")

        recyclerview_choose_conditioning_exercise.adapter = adapter
        recyclerview_choose_conditioning_exercise.addItemDecoration(DividerItemDecoration(this, DividerItemDecoration.VERTICAL))

        adapter.setOnItemClickListener { item, _ ->
            val exerciseRecyclerviewRowItem = item as ChooseExerciseRow
            val intent = Intent(this, EditConditioningActivity::class.java)
            conditioningExerciseClicked = exerciseRecyclerviewRowItem.exerciseDatabaseObject
