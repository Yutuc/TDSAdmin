...
import com.univation.tdsadmin.*
import com.univation.tdsadmin.adapters.WarmupExerciseRow
import com.univation.tdsadmin.adapters.WarmupTitlesRow
import com.univation.tdsadmin.adapters.WorkoutExerciseRow
import com.univation.tdsadmin.adapters.WorkoutTitlesRow
...
class AddWorkoutActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        var workoutArrayList = ArrayList<MainExerciseObject>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        workout_card_recyclerview.adapter =
            workoutCardAdapter
        warmup_card_recyclerview.adapter =
            warmupCardAdapter
    ...
    private fun refreshWorkoutRecycler(){
        val updatedWorkoutArrayList = intent.getParcelableArrayListExtra<MainExerciseObject>(
            WORKOUT_ARRAY_LIST
        )
    ...
    private fun refreshWarmupRecycler(){
        ...
        warmupArrayList.forEach{
            warmupCardAdapter.add((WarmupExerciseRow(
                it
            )))
        }
