...
class ChooseUserForViewCheckInsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerview_choose_user_for_checkins.addItemDecoration(DividerItemDecoration(this, DividerItemDecoration.VERTICAL))
        recyclerview_choose_user_for_checkins.adapter = adapter
